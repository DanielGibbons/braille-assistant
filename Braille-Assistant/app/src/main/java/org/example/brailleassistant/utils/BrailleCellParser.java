...
public class BrailleCellParser {

    private int mBrailleGrade;
    private GradeOneLUTs gradeOneLUTs;
    private FormattingLUTs formattingLUTs;


    public BrailleCellParser(int brailleGrade) {

        this.mBrailleGrade = brailleGrade;
        this.gradeOneLUTs = new GradeOneLUTs();
        this.formattingLUTs = new FormattingLUTs();

    }

    // 0 - Grade 1
    // 1 - Grade 2
    public void setBrailleGrade(int brailleGrade) {

        this.mBrailleGrade = brailleGrade;

    }

    public String[][] parseBraille(short[][] brailleCellValues) {

        if (this.mBrailleGrade == 0) { // Grade 1

            String[][] grade1Braille = this.grade1BrailleParser(brailleCellValues);
            String[][] fontFormattedBraille = this.fontFormatter(grade1Braille);

            return this.characterFormatter(fontFormattedBraille);

        } else if (this.mBrailleGrade == 1) { // Grade 2

            String[][] grade1Braille = this.grade1BrailleParser(brailleCellValues);
            String[][] grade2Braille = this.grade2BrailleParser(grade1Braille);
            String[][] fontFormattedBraille = this.fontFormatter(grade2Braille);
        ...
        for (int brailleLine = 0; brailleLine < brailleCellValues.length; brailleLine++) {
            ...
            for (int brailleCell = 0; brailleCell < brailleCellValues[0].length; brailleCell++) {
                ...
                while (redoRequired) {
                    ...
                    // no prefix in parser
                    if (parserInformation.mPrefixState == BraillePrefixState_t.None) {
                        ...
                        if (prefix < 0) {
                            ...
                            parserInformation.mNumberMode = false;
                            parserInformation.mPrefixState = BraillePrefixState_t.Stage1;
                            parserInformation.mPrefixStage1Value = gradeOneLUTs.prefixes[prefix];

                        }

                    } else if (parserInformation.mPrefixState == BraillePrefixState_t.Stage1) {
                        ...
                        if (parserInformation.mPrefixStage1Value == 8) {
                            ...
                            if (Objects.equals(lutTranslation, "DAGGER_INDICATOR")) {
                                parserInformation.mPrefixState = BraillePrefixState_t.Stage2;
                    ...
                    } else if (parserInformation.mPrefixState == BraillePrefixState_t.Stage2) {
            ...
            for (int brailleCell = 0; brailleCell < gradeParserOutput[0].length; brailleCell++) {
                ...
                if (Objects.equals(str, "<cl>") || Objects.equals(str, "<cw>") || Objects.equals(str, "<c>") || Objects.equals(str, "</c>")) { // capital indicator
                    ...
                    if (Objects.equals(str, "</c>")) { // Apostrophe or capital terminator
                        ...
                        switch (str) {
                            case "<cl>":
                                capitalInformation.mCapitalDuration = Duration_t.Symbol;
                                break;
                            case "<cw>":
                                capitalInformation.mCapitalDuration = Duration_t.Word;
                                break;
                            case "<c>":
                                capitalInformation.mCapitalDuration = Duration_t.Passage;
                                break;
                        }
                    }
                    ...
                    if (Objects.equals(gradeParserOutput[brailleLine][brailleCell], " ")) {
                        ...
                        if (capitalInformation.mCapitalMode && capitalInformation.mCapitalDuration == Duration_t.Word) {
                            capitalInformation.clearCapitalData();
                        }
                        ...
                        if (accentLigatureScriptDetected) { // check for accents ligatures subscripts or superscripts
                            ...
                            if (capitalInformation.mCapitalMode) {
                                ...
                                if (lutTranslation == null) {
                                    ...
                                    if (capitalInformation.mCapitalDuration == Duration_t.Symbol) {
                                        capitalInformation.clearCapitalData();
                                    }
    ...
    class BrailleInformation {
        ...
        public BraillePrefixState_t mPrefixState;
        ...
        public BrailleInformation() {
            ...
            this.mPrefixState = BraillePrefixState_t.None;
    ...
    class CapitalInformation {
        ...
        public Duration_t mCapitalDuration;


        public CapitalInformation() {
            this.mCapitalMode = false;
            this.mCapitalDuration = Duration_t.None;
        }
