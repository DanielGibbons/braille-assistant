...
public class BrailleCellCalculator {

    public BrailleCellCalculator() {

    }

    public short[][] calculateBrailleCells(short[] brailleCellLines, short[] brailleCellColumns, double[][] brailleDotLocations) {

        short[] internalBrailleCellRows = this.calculateInternalBrailleCellRows(brailleCellLines);
        ArrayList[] brailleLineDotLocations = this.classifyDotsIntoBrailleRows(brailleCellLines, internalBrailleCellRows, brailleDotLocations);

        return this.extractBrailleCells(brailleCellColumns, brailleLineDotLocations);
